...
: Renderer(RenderApi::Vulkan),
  ...
  m_dynamic_uniform(OBJECT_INSTANCES) {
}
...
void VulkanRenderer::create_swapchain_dependents() {
    m_dynamic_uniform.create(m_physical_device, m_device);
