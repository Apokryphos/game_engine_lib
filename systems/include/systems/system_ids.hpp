...
static inline const common::SystemId SYSTEM_ID_MOVE      = _ID + 4;
static inline const common::SystemId SYSTEM_ID_POSITION  = _ID + 5;
static inline const common::SystemId SYSTEM_ID_SPRITE    = _ID + 6;
