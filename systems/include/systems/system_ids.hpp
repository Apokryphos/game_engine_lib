...
static inline const common::SystemId SYSTEM_ID_MODEL     = _ID + 4;
static inline const common::SystemId SYSTEM_ID_MOVE      = _ID + 5;
static inline const common::SystemId SYSTEM_ID_POSITION  = _ID + 6;
static inline const common::SystemId SYSTEM_ID_SPINE     = _ID + 7;
static inline const common::SystemId SYSTEM_ID_SPRITE    = _ID + 8;
